...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the interface name "IUserInfoStorage" in both code and config file together.
    [ServiceContract]
    ...
    public class Service : IUserInfoStorage
    {
